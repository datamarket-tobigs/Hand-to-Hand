...
Code reference: https://github.com/pierre-rouanet/dtw, https://github.com/BenSaunders27/ProgressiveTransformersSLP/blob/master/helpers.py
"""
...
def calculate_dtw(references, hypotheses):
    ...
    d, cost_matrix, acc_cost_matrix, path = dtw(references, hypotheses, dist=euclidean_norm)

    # Normalise the dtw cost by sequence length
    dtw_scores = d/acc_cost_matrix.shape[0]
